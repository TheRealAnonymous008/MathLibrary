...
void Addition(Benchmark& b) {
	...
	auto x = Generator::Integer<1000>();
	auto y = Generator::Integer<1000>();
...
int main() {
	...
	Benchmark benchmark = Benchmark("Integers");
